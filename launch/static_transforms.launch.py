...
def generate_launch_description():
    ...
    odom_base_broadcaster = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        arguments=['0', '0', '0', '0', '0', '0', odom_frame, base_link_frame],
        output='screen'
    )
    ...
    base_laser_broadcaster = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        arguments=['0', '0', '0', '0', '0', '0', base_link_frame, laser_link_frame],
        output='screen'
    )
    ...
    base_imu_broadcaster = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        arguments=['0', '0', '0', '0', '0', '0', base_link_frame, imu_link_frame],
        output='screen'
    )
    ...
    base_camera_broadcaster = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        arguments=['0', '0', '0', '0', '0', '0', base_link_frame, camera_link_frame],
        output='screen'
    )

    # Create the launch description and add the nodes
    ld = LaunchDescription()
    ld.add_action(map_odom_broadcaster)
    ld.add_action(odom_base_broadcaster)
